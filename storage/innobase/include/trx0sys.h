...
public:
  void init()
  {
    alloc_pool= my_mmap(0, my_system_page_size * 1000, PROT_READ | PROT_WRITE,
                        MAP_PRIVATE | MAP_ANONYMOUS | MAP_NORESERVE, -1, 0);
    offset= 0;
    dummy_offset= my_system_page_size * 1000 - LF_HASH_OVERHEAD;
  ...
  void destroy()
  {
    ...
    if (alloc_pool)
      my_munmap(alloc_pool, my_system_page_size * 1000);
  }
